...
#include "PKH/Passer_FBI/BTDecorator_FBIShoot.h"
#include "BehaviorTree/BlackboardComponent.h"
#include "AIController.h"
#include "PKH/Passer/PasserAIKey.h"
#include "Passer_FBI.h"

UBTDecorator_FBIShoot::UBTDecorator_FBIShoot()
{
	NodeName = TEXT("CanShoot");
}

bool UBTDecorator_FBIShoot::CalculateRawConditionValue(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory) const
{
